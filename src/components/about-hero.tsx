        ...
        <AnimatePresence>
          ...
          <FadeUp key="description-1" duration={0.6} delay={0.2}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              I am a passionate Computer Science student specialized in AI/ML and MLOps. 
              I focus on building intelligent systems and seamless web experiences, 
              bringing a data-driven approach and technical rigor to every project I undertake.
            </p>
          </FadeUp>
          <FadeUp key="description-2" duration={0.6} delay={0.4}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              ...
              showcasing my expertise in Python, Reactjs, Machine Learning, 

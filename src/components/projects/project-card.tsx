...
export default function ProjectCard(props: ProjectCardProps) {
  // Guard against missing properties that cause build crashes
  ...
  return (
    ...
    >
      {/* Ensure imageUrl exists before passing to Corosel */}
      ...
      <div className="p-3 text-foreground sm:p-4">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-semibold">{props.name || "Untitled Project"}</span>
        </div>
        <div className="mt-3">
          <p className="text-xs md:text-sm">{props.description || "No description provided."}</p>
        </div>
